...
public class IconHeaderItemPresenter extends RowHeaderPresenter {
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        ...
        if(headerItem.getName() == "FILMS") {

            Drawable icon = rootView.getResources().getDrawable(R.drawable.ic_metrage, null);
            iconView.setImageDrawable(icon);
        }

        else if(headerItem.getName() == "SERIES") {

            Drawable icon = rootView.getResources().getDrawable(R.drawable.ic_serie, null);
            iconView.setImageDrawable(icon);
        }

        else if(headerItem.getName() == "PARAMETRES") {

            Drawable icon = rootView.getResources().getDrawable(R.drawable.ic_setting, null);
            iconView.setImageDrawable(icon);
        }
