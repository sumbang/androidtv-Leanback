...
public class GuidedStepActivity extends FragmentActivity {
    ...
    private static void addEditTextAction(
            Context context,
            List<GuidedAction> actions,
            EditText text
            ){
    ...
    public static class FirstStepFragment extends GuidedStepSupportFragment {
        ...
        public Guidance onCreateGuidance(@NonNull Bundle savedInstanceState) {
            ...
            String breadcrumb = "";
            String description = getString(R.string.pin);
            Drawable icon = getActivity().getDrawable(R.drawable.logo);
        ...
        public void onCreateActions(@NonNull List<GuidedAction> actions,
            ...
            myEditText.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));

           // actions.add(myEditText);
